...
public class CostCalculator {
    ...
    public final BigDecimal getCustomerBasketCost(ProductStore store, CustomerCategory category) {
        final BigDecimal discountPercentage = new BigDecimal(this.discountInfo.getDiscountPercentage(category));
        return getProductStoreCost(store, discountPercentage);
    }

    public final BigDecimal getCustomerBasketBonuses(ProductStore store, CustomerCategory category) {
        final BigDecimal discountPercentage = new BigDecimal(this.discountInfo.getDiscountPercentage(category));
        return getProductStoreBonuses(store, discountPercentage);
    }
