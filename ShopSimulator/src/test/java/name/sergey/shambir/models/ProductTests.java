...
public class ProductTests extends Assert {
    ...
    public void testEquals() {
        ...
        final Product cigarettes1 = new Product("cigarettes", Product.Category.Smockables, QuantityCategory.Countable,
                                                price, new BigDecimal(1));
        final Product cigarettes2 =
            new Product("cigarettes", Product.Category.Smockables, QuantityCategory.Countable, price.doubleValue(), 1);
        final Product cigarettes3 =
            new Product("cigarettes", Product.Category.Smockables, QuantityCategory.Countable, price.doubleValue(), 3);
        final Product milk =
            new Product("milk", Product.Category.Food, QuantityCategory.Uncountable, price.doubleValue(), 1);
