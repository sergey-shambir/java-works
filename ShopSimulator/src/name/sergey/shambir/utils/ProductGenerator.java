...
public class ProductGenerator {
    private static final String[] FOOD_NAMES = {
        "milk", "chocolate", "cocoa", "coffee", "meal", "tomato", "potato", "onion", "beef", "ham", "chicken"
    };
    ...
    private static final String[] HYGIENE_PRODUCT_NAMES = {
        "wipes", "soap", "shampoo", "comb", "hairdryer", "toothbrush", "toothpaste"
    };
    private static final String[] ALCOHOL_NAMES = {
        "wine", "whiskey", "beer", "liquor", "tequila", "martini"
    };
    private static final String[] SMOCKABLE_NAMES = {
        "cigarettes", "cigar"
    };
