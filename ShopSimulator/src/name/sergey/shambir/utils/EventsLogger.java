...
public class EventsLogger {
    ...
    public void logCustomerEntered(String name, int customerCount) {
        System.out.printf(
            "[%s] New customer '%s' arrived, there are %d customers\n",
            getTime(), name, customerCount);
    }

    public void logCustomerPickUpProduct(String name, String productName,
                                         int count) {
        ...
        switch (productsNames.length) {
            ...
            default: {
                final String remaining =
                    Integer.toString(productsNames.length - 2);
                text += productsNames[0] + ", " + productsNames[1] + " and " +
